...
public interface TableFactory {
    ...
    default Table createNameless(ReportPage reportPage, String providedTableName, String firstRowString, String lastRowString, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        ...
        // add fantom first line for provided table name
        create(// add fantom first line for provided table name
        reportPage, // add fantom first line for provided table name
        providedTableName, reportPage.getTableCellRange(firstRowString, headersRowCount, lastRowString).addRowsToTop(1), headerDescription, headersRowCount);
    }
    ...
    default Table createNameless(ReportPage reportPage, String providedTableName, String firstRowString, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        ...
        create(// add fantom first line for provided table name
        reportPage, // add fantom first line for provided table name
        providedTableName, reportPage.getTableCellRange(firstRowString, headersRowCount).addRowsToTop(1), headerDescription, headersRowCount);
    }
    ...
    default Table createNameless(ReportPage reportPage, String providedTableName, Predicate<Object> firstRowFinder, Predicate<Object> lastRowFinder, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        ...
        create(// add fantom first line for provided table name
        reportPage, // add fantom first line for provided table name
        providedTableName, reportPage.getTableCellRange(firstRowFinder, headersRowCount, lastRowFinder).addRowsToTop(1), headerDescription, headersRowCount);
    }
